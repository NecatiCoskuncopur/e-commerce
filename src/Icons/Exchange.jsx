const Exchange = ({ size = 60, color = 'currentColor', ...props }) => (
  <svg
    width={size}
    height={size}
    version="1.1"
  ...
  >
    <path
      fill="#FFD910"
      d="M56.4,33.4v-6c0-2.5-1-5-2.8-6.8c-1.8-1.8-4.2-2.8-6.8-2.8H9.6c-0.5,0-1-0.1-1.4-0.3c-0.4-0.2-0.9-0.5-1.2-0.8
    ...
    <path
      fill={color}
      d="M54,35.8v6H38.4v-6H54z M54.9,29.9H37.5c-1.4,0-2.7,0.5-3.6,1.5c-1,1-1.5,2.3-1.5,3.6v7.7
