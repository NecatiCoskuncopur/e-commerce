const Discount = ({ size = 60, color = 'currentColor', ...props }) => (
  <svg
    width={size}
    height={size}
    version="1.1"
  ...
  >
    <path
      fill="#FFD910"
      d="M58.6,16.7l-7.1-9.6c-0.7-1-1.7-1.7-2.8-2.3C47.6,4.3,46.4,4,45.2,4H14.8c-1.2,0-2.5,0.3-3.6,0.8
    ...
    <path
      fill={color}
      d="M39,25.2H21c-1.7,0-3,1.3-3,3c0,1.7,1.3,3,3,3h18c1.7,0,3-1.3,3-3C42,26.5,40.7,25.2,39,25.2z"
    />
  </svg>
);
